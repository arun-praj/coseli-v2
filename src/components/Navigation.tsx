                ...
                <div className="flex items-center gap-4 md:gap-6 text-sm font-medium z-[60]">
                    ...
                    <div className="relative group">
                        ...
                        <div className="fixed top-[64px] md:top-[80px] left-0 w-full md:absolute md:top-[calc(100%+1px)] md:left-auto md:right-0 md:w-80 bg-white md:border border-zinc-200 border-b shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 md:translate-y-2 group-hover:translate-y-0 z-50 flex flex-col cursor-default">
                            <div className="p-5 border-b border-zinc-100 flex gap-4">
                                <div className="relative w-16 aspect-[4/5] bg-zinc-50 shrink-0">
                                    <Image
                                        src="https://images.unsplash.com/photo-1614252332824-34df734c38d4?q=80&w=300&auto=format&fit=crop"
                                ...
                                <div className="flex flex-col flex-1 justify-center">
                                    <span className="font-serif text-base text-black leading-tight mb-1">The Oxford Classic</span>
                                    <span className="text-xs text-zinc-500 mb-2">Qty: 1</span>
                                    <span className="font-medium text-black text-sm">Rs. 320.00</span>
                                </div>
                            </div>
                            <div className="p-5 bg-zinc-50">
                                <div className="flex justify-between items-center mb-4">
                                    <span className="text-sm text-zinc-600">Subtotal</span>
                                    <span className="font-medium text-black">Rs. 320.00</span>
                                </div>
                                <CheckoutButton
                                    href="/checkout"
                                    text="Go to Checkout"
