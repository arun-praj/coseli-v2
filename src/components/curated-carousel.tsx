        ...
        >
            ...
            <CarouselContent className="-ml-4 sm:-ml-8">
                {products.map((product) => (
                    <CarouselItem key={product.id} className="pl-4 sm:pl-8 sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
                        <a href={`/products/${product.id}`} className="group cursor-pointer block">
                            ...
                            <div className="flex flex-col xl:flex-row justify-between items-start">
                                ...
                                <span className="font-sans text-sm mt-1 xl:mt-2 text-black">Rs. {product.base_price.toFixed(2)}</span>
                            </div>
                        </a>
                    </CarouselItem>
                ))}
